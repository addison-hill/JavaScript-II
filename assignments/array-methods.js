...
// Problem 1
// The 5k wants to send out an email to all the companies of the runners appraising them their contributions.
...
// Problem 2
// The 5k wants to send a letter thanking all of the people who donated over a 200 dollars.

let over200 = runners.filter(function(item){
...
// Problem 3
// The 5k wants to have two starting lines one for the odd and one for the even, make an array with only odd ids.

let odds = runners.filter(function(item){
  return item.id % 2;
}); 
